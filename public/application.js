...
// add project
var onAddProject = function onAddProject(event) {
  event.preventDefault();
  // console.log('add project ran!')

  var data = getFormFields(event.target);
  document.getElementById('add-project').reset();
  api.addProject(data).then(ui.addProjectSuccess).then(function () {
    return onGetProjects(event);
  }).catch(ui.addProjectFailure);
};

var onGetProjects = function onGetProjects(event) {
  event.preventDefault();
  api.getProjects().then(ui.getMyProjectsSuccess).catch(ui.getMyProjectsFailure);
};

var onShowAllProjects = function onShowAllProjects(event) {
  event.preventDefault();
  api.showAllProjects().then(ui.getProjectsSuccess).catch(ui.getProjectsFailure);
};
...
var onUpdateProject = function onUpdateProject(event) {
  ...
  api.updateProject(data).then(ui.updateProjectSuccess).then(function () {
    return onGetProjects(event);
...
var onDeleteProject = function onDeleteProject(event) {
  event.preventDefault();
  var data = $(event.target).closest('ul').attr('data-id');

  api.deleteProject(data).then(ui.deleteProjectSuccess).then(function () {
    return onGetProjects(event);
...
var showAllProjects = function showAllProjects(data) {
...
var deleteProject = function deleteProject(data) {
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://pacific-reaches-33989.herokuapp.com',
...
var store = __webpack_require__(3);
var showProjectsTemplate = __webpack_require__(15);
var myProjectsTemplate = __webpack_require__(32);
...
var getProjectsFailure = function getProjectsFailure() {
...
// showMyProjectsHtml
var getMyProjectsSuccess = function getMyProjectsSuccess(data) {
  // console.log(data)
  var showMyProjectsHtml = myProjectsTemplate({ projects: data.user.projects });
...
var getMyProjectsFailure = function getMyProjectsFailure() {
  $('#message').text('Sorry, Something went wrong. Try again!');
  $('#message').css('background-color', 'red');
  setTimeout(function () {
    $('#message').text('');
...
// add project
var addProjectSuccess = function addProjectSuccess(data) {
...
var addProjectFailure = function addProjectFailure() {
...
module.exports = {
  ...
  getProjectsFailure: getProjectsFailure,
  ...
  getMyProjectsSuccess: getMyProjectsSuccess,
  getMyProjectsFailure: getMyProjectsFailure
  // clearProjects
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <h1 data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.project_title : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "            <div></div>\n\n  Difficulty:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.difficulty_id : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "      <div></div>\n\nID:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </ul>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.project_title : stack1), depth0))
    + "\n";
  ...
  return "        "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.difficulty_id : stack1), depth0))
    + "\n";
},"8":function(container,depth0,helpers,partials,data) {
    return "        It can't be that difficult!\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <h1 data-id=\""
    ...
    + "                  <div></div>\n\n      Difficulty:\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.difficulty_id : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n<div>\n    <button class=\"remove-button\" type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Remove</button>\n</div>\n  </ul>\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
